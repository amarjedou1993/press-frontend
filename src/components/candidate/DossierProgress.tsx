...
// The four stages of a dossier, as a stepper the candidate can read at a
// glance. Mirrors the admin session stepper deliberately: staff and
// candidates should recognise the same process in the same shape.
//
// Maps the nine backend states onto four human stages, because "UNDER_FINAL
// _REVIEW" means nothing to a journalist — "Examen" does.
