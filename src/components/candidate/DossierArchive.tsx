...
// The documents and the history, folded away after a decision.
//
// WHY FOLD RATHER THAN DELETE. Once a decision exists, the page has one job:
// deliver the notice. A document list and a timeline sitting fully expanded
// beneath it compete with the thing that actually matters, and on a phone
// they push the decision off the screen entirely.
//
// But they cannot be removed either. A candidate contesting a rejection needs
// exactly this material to write their objection — what they submitted, and
// what happened when. Folding resolves it: invisible when not needed, one
// click when it is.
//
// OPEN BY DEFAULT ON A REFUSAL, closed otherwise. Someone who has been
// refused will want it; someone who has been accepted almost certainly will
// not.
//
// Built on <details>/<summary>: keyboard-accessible and functional without
